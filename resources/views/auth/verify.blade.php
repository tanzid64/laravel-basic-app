                        ...
                        <div class="row">
                            <div class="col-md-7 mx-auto">
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="pt-0">
                                        <form method="POST" action="{{ route('admin.verification.verify') }}" class="my-4">
                                            @csrf
                                            @if(session('error'))
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="text" id="verification_code" name="verification_code" required="" placeholder="Enter your verification code">
